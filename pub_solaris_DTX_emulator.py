...
import time
solaris_sensors_lorawan_mqtt = '[{"channel":902500000, "sf":7, "time":"2022-05-03T15:42:39+08:00", "gwip":"192.168.88.3", "gwid":"000080029c2b2a5d", "repeater":"00000000ffffffff", "systype":5, "rssi":-35.0, "snr":25.5, "snr_max":37.0, "snr_min":14.5, "macAddr":"0000000005000001", "data":"38383633353939393930303930303030303034303431333531343034313335313430343133353134303431333531343034313335313430343133353134303431333531343034313335313430343133353134303431333531", "frameCnt":8, "fport":1}]'
solaris_sensor_lorawan_data = "8863599990090000004041351404135140413514041351404135140413514041351404135140413514041351"
# solaris_sensor_lorawan_data_hex = "38383633353939393930303930303030303034303431333531343034313335313430343133353134303431333531343034313335313430343133353134303431333531343034313335313430343133353134303431333531"
solaris_sensor_lorawan_data_hex = solaris_sensor_lorawan_data.encode().hex()
...
parser.add_option(
    "-d", "--data", action="store", dest="data", default=solaris_sensor_lorawan_data_hex, help="sending data"
)
parser.add_option(
    "-i",
    "--ip",
